...
final class Subject
{
    ...
    #[ORM\Embedded(class: SubjectName::class, columnPrefix: false)]
    ...
    public function toArray(): array
    {
        return [
            ...
            'teacher' => [
                'id' => $this->teacher->getId()->value(),
                'name' => $this->teacher->getName()->value(),
                'surname' => $this->teacher->getSurname()->value(),
            ],
        ];
    }
}