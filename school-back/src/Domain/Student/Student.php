...
final class Student
{
    ...
    public function setId(StudentId $id): void
    {
        $value = trim($id->value());
    ...
    public function setName(StudentName $name): void
    {
    ...
    public function setSurname(StudentSurname $surname): void
    {
    ...
    public function setDni(StudentDni $dni): void
    {
    ...
    public function setMail(StudentMail $mail): void
    {
    ...
    public function toArray(): array
    {
        return [
            ...
            'course' => [
                'id' => $this->course->getId()->value(),
                'name' => $this->course->getName()->value(),
            ],
        ];
    }
}